...
require('lazy').setup({
  -- Here is an advanced example where we pass configuration
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      local additional_args = { '--hidden', '-g', '!.git/*', '-g', '!*.pdf' }
      require('telescope').setup {
        ...
        pickers = {
          find_files = {
            find_command = { 'rg', '--files', unpack(additional_args) },
          },
          grep_string = {
      ...
      -- Search by frecency
      vim.keymap.set('n', '<leader>o', '<cmd>Telescope frecency workspace=CWD<CR>', { desc = '[S]earch Hist[o]ry' })
    end,
  },
